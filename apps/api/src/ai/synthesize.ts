...
- competitors.marketRivals: ALWAYS populate 2-5 main industry peers of the TARGET COMPANY (not the product). Use your knowledge of the industry — e.g. Infosys → TCS, Wipro, HCL, Cognizant; Naukri → Monster, LinkedIn, Indeed. trafficComparison values must be lowercase: higher, similar, lower, or unknown.
- competitors.displacementTargets: tools the PRODUCT being sold can displace at this company. Cross-reference the product's displacedCompetitors list with the company's tech stack (ats, hris, crm, erp). Only populate if there is a genuine match. displacementAngle must be a specific, evidence-based hook. difficulty values must be lowercase: high, medium, or low.
